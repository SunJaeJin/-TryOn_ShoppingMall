...
module.exports = class Recomment extends Sequelize.Model {
  ...
  static associate(db) {
    ...
    db.Recomment.belongsTo(db.AIModel, { foreignKey: 'AIModelId', as: 'AIModel' });
    db.Recomment.belongsTo(db.User, { foreignKey: 'UserId', as: 'user' });
    db.Recomment.belongsTo(db.Comment, { foreignKey: 'CommentId', as: 'Comment' });
  }
};