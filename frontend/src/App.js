...
//import ProductModify from "./pages/shop/ProductModify";
...
// shop pages
//제품등록 페이지
const ProductRegister = lazy(() => import("./pages/shop/ProductRegister"));
const ProductModify = lazy(() => import("./pages/shop/ProductModify"));
...
const AdminPage = lazy(() => import("./pages/other/AdminPage"));
        ...
        <ScrollToTop>
          ...
          >
            <Routes>
              ...
              />
              <Route
                path={process.env.PUBLIC_URL + "/Product-Register"}
              ...
              />
              <Route
                  path={process.env.PUBLIC_URL + "/shop/product-register"}
                  element={<ProductRegister />}
              />
              <Route
                  path={process.env.PUBLIC_URL + "/shop/product-Modify/:id"}
              ...
              />
              <Route
                path={process.env.PUBLIC_URL + "/admin-page"}
                element={<AdminPage/>}
              />
